...
#define errno_to_idx(code) (0 ? -1 \
  ...
  : ((code >= 100) && (code <= 126)) ? (code - 61) \
  : ((code >= 128) && (code <= 130)) ? (code - 62) \
  : ((code >= 132) && (code <= 132)) ? (code - 63) \
  : ((code >= 134) && (code <= 140)) ? (code - 64) \
  : ((code >= 10004) && (code <= 10004)) ? (code - 9927) \
  : ((code >= 10009) && (code <= 10009)) ? (code - 9931) \
  : ((code >= 10013) && (code <= 10014)) ? (code - 9934) \
  : ((code >= 10022) && (code <= 10022)) ? (code - 9941) \
  : ((code >= 10024) && (code <= 10024)) ? (code - 9942) \
  : ((code >= 10035) && (code <= 10071)) ? (code - 9952) \
  : -1)
